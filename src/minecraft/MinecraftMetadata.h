...
public:
    ...
    [[nodiscard]] MinecraftVersion createLoaderVersion(const MinecraftVersion &minecraftVersion, const QString &loaderName, DownloadManager &downloads, const QString &javaPath = {}, QString *errorMessage = nullptr);
...
private:
    ...
    [[nodiscard]] MinecraftVersion installForgeVersion(const MinecraftVersion &minecraftVersion, DownloadManager &downloads, const QString &javaPath, QString *errorMessage = nullptr);

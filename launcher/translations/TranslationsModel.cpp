...
struct Language {
    ...
    QString languageName() const
    {
        static const QHash<QString, QString> names = {
            { "en_US", QStringLiteral("English (United States)") },
            { "en_GB", QStringLiteral("English (United Kingdom)") },
            { "en_NZ", QStringLiteral("English (New Zealand)") },
            { "en_CA", QStringLiteral("English (Canada)") },
            { "en_AU", QStringLiteral("English (Australia)") },
            { "it_IT", QStringLiteral("Italiano") },
            { "de_DE", QStringLiteral("Deutsch") },
            { "fr_FR", QStringLiteral("Français") },
            { "es_ES", QStringLiteral("Español (España)") },
            { "es_UY", QStringLiteral("Español (Latinoamérica)") },
            { "es_MX", QStringLiteral("Español (México)") },
            { "es_AR", QStringLiteral("Español (Argentina)") },
            { "pt_BR", QStringLiteral("Português (Brasil)") },
            { "pt_PT", QStringLiteral("Português (Portugal)") },
            { "pl_PL", QStringLiteral("Polski") },
            { "ru_RU", QStringLiteral("Русский") },
            { "uk_UA", QStringLiteral("Українська") },
            { "cs_CZ", QStringLiteral("Čeština") },
            { "sk_SK", QStringLiteral("Slovenčina") },
            { "hu_HU", QStringLiteral("Magyar") },
            { "ro_RO", QStringLiteral("Română") },
            { "nl_NL", QStringLiteral("Nederlands") },
            { "sv_SE", QStringLiteral("Svenska") },
            { "da_DK", QStringLiteral("Dansk") },
            { "nb_NO", QStringLiteral("Norsk bokmål") },
            { "fi_FI", QStringLiteral("Suomi") },
            { "el_GR", QStringLiteral("Ελληνικά") },
            { "tr_TR", QStringLiteral("Türkçe") },
            { "ar_SA", QStringLiteral("العربية") },
            { "he_IL", QStringLiteral("עברית") },
            { "zh_CN", QStringLiteral("简体中文") },
            { "zh_TW", QStringLiteral("繁體中文") },
            { "ja_JP", QStringLiteral("日本語") },
            { "ja_KANJI", QStringLiteral("日本語 (漢字)") },
            { "ko_KR", QStringLiteral("한국어") },
            { "vi_VN", QStringLiteral("Tiếng Việt") },
            { "th_TH", QStringLiteral("ไทย") },
            { "id_ID", QStringLiteral("Bahasa Indonesia") },
            { "hi_IN", QStringLiteral("हिन्दी") },
            { "bg_BG", QStringLiteral("Български") },
            { "hr_HR", QStringLiteral("Hrvatski") },
            { "sr_RS", QStringLiteral("Српски") },
            { "sl_SI", QStringLiteral("Slovenščina") },
            { "lt_LT", QStringLiteral("Lietuvių") },
            { "lv_LV", QStringLiteral("Latviešu") },
            { "et_EE", QStringLiteral("Eesti") },
            { "ca_ES", QStringLiteral("Català") },
            { "gl_ES", QStringLiteral("Galego") },
            { "eu_ES", QStringLiteral("Euskara") },
            { "be_BY", QStringLiteral("Беларуская") },
            { "tok", QStringLiteral("toki pona") },
            { "nan", QStringLiteral("閩南語") },
            { "en@pirate", QStringLiteral("Pirate English") },
            { "en@uwu", QStringLiteral("UwU English") },
        };
